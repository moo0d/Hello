...
public class Asiakas2 {
    ...
    public void setAloitusAika(long aloAika) {
        this.aloitusAika = aloAika;
    }

    public static void main(String[] args) {

        Asiakas2 asiakas1 = new Asiakas2();
        Asiakas2 asiakas2 = new Asiakas2();
        Asiakas2 asiakas3 = new Asiakas2();
        Asiakas2 asiakas4 = new Asiakas2();
